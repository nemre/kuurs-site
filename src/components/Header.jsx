...
export default function Header(props) {
  return (
    <div class='flex p-4'>
      <a href='#' class='rounded-2xl flex text-red-500 p-2 bg-black bg-opacity-0 hover:bg-opacity-10 space-x-2'>
        <svg class='w-6 h-6 fill-current'>
          <path d={Utils.Icons.video} />
        </svg>
        <span>Kurslar</span>
      </a>
      <a href='#' class='rounded-2xl flex p-2 bg-black bg-opacity-0 hover:bg-opacity-10 space-x-2'>
